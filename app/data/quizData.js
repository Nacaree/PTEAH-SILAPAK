...
export const characters = {
  anita: {
    id: "anita", name: bi("Anita", "អានីតា (Anita)"), archetype: bi("The one who carries too much", "មនុស្សដែលលាក់ទុកសម្ពាធច្រើន"), color: "#feb2bf", mark: "~", image: "/assets/PS%20ASSEST%20UI-21.png",
  ...
  kimly: {
    id: "kimly", name: bi("Kimly", "គឹមលី (Kimly)"), archetype: bi("The One Who Makes Life Feel Lighter", "មនុស្សដែលធ្វើឱ្យជីវិតមានពណ៌សោភ័ណ"), color: "#b5d627", mark: "✦", image: "/assets/PS%20ASSEST%20UI-23.png",
  ...
  vitou: {
    id: "vitou", name: bi("Vitou", "វិទូ (Vitou)"), archetype: bi("The One Who Never Stop Exploring.", "មនុស្សដែលមិនដែលឈប់រុករក"), color: "#66883e", mark: "?", image: "/assets/Vitou.png",
  ...
  mc: {
    id: "mc", name: bi("MC", "MC"), archetype: bi("The One Looking For The Right Answer.", "មនុស្សដែលតែងតែស្វែងរកចម្លើយដ៏ត្រឹមត្រូវ"), color: "#1a4c19", mark: "…", image: "/assets/PS%20ASSEST%20UI-24.png",
